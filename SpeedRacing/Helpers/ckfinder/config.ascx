...
<script runat="server">
	...
	public override void SetConfig()
	{
		...
		//BaseUrl = "~/Content/UserImages/";
        BaseUrl = "~/images/CKFinder/userImages/";

		// The phisical directory in the server where the file will end up. If
		// blank, CKFinder attempts to resolve BaseUrl.
        //BaseDir = HttpContext.Current.Server.MapPath("/Content/UserImages/");
        BaseDir = HttpContext.Current.Server.MapPath("/images/CKFinder/userImages/");
